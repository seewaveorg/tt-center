var site_settings = '<div hidden="true" class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" id="fixheader" class="icheckbox" name="st_head_fixed" value="1"/> Fixed Header</label>'
        +'</div>'
        +'<div class="ts-row">'
