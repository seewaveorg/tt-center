        ...
        <!-- START PAGE CONTAINER -->
            ...
            <!-- PAGE CONTENT -->
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Company Registration</h2>
                </div>                   
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                         ...
                         <form:form method="post" modelAttribute="company" action="saveCompany.do" class="form-horizontal">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">                                        
                                     ...
                                     <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Address Line 1 : </label>
                                        <div class="col-md-6 col-xs-12">  
                                            <div class="input-group">
                                                <span class="input-group-addon"></span>                                          
                                            	<form:input path="addressLine1" class="form-control" rows="5" placeholder="Address Line 1"/>
                                           </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">  
                                            <div class="input-group">
                                                <span class="input-group-addon"></span>                                          
                                                <form:input path="addressLine2" class="form-control" rows="5" placeholder="Address Line 2"/>
                                           </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Address Line 3 : </label>
                                        <div class="col-md-6 col-xs-12">  
                                            <div class="input-group">
                                                <span class="input-group-addon"></span>                                          
                                                <form:input path="addressLine3" class="form-control" rows="5" placeholder="Address Line 3"/>
                                           </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">  
                                            <div class="input-group">
                                                <span class="input-group-addon"></span>                                          
                                                <form:input path="email" class="form-control" rows="5" placeholder="Email"/>
                                           </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">  
                                            <div class="input-group">
                                                <span class="input-group-addon"></span>                                          
                                                <form:input path="telephone" class="form-control" rows="5" placeholder="Telephone"/>
                                           </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">  
                                            <div class="input-group">
                                                <span class="input-group-addon"></span>                                          
                                                <form:input path="fax" class="form-control" rows="5" placeholder="Fax"/>
                                           </div>
                                        </div>
                                    </div>
                                    <!--  -->
