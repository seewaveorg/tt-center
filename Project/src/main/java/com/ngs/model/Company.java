...
public class Company  implements java.io.Serializable {
    ...
    public Company(String name, String addressLine1, String addressLine2, String addressLine3, String email, String telephone, String fax, Integer status, Set<Systems> systemses, Set<Tt> tts, Set<Department> departments, Set<User> users, Set<Branch> branches) {
       this.name = name;
