...
public class Parameters  implements java.io.Serializable {
    ...
    public Parameters(String name, String comment, Date regtime, String upperValue, String lowValue, String upperComment, String lowerComment, String unit, Integer status, Set systemsHasParameterses, Set requests) {
       this.name = name;
