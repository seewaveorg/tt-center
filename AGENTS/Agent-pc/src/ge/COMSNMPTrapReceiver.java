 ...
 * 
 */
public class COMSNMPTrapReceiver implements CommandResponder {
	...
	public COMSNMPTrapReceiver() {
	}

	public static void main(String[] args) {
            try {
                COMSNMPTrapReceiver GEtrap = new COMSNMPTrapReceiver();
        ...
        * **/
               ...
               // timer.schedule(new MyTimerTask(), 0, 60000); // every 60 seconds
                ...
                Logger.getLogger(COMSNMPTrapReceiver.class.getName()).log(Level.SEVERE, null, ex);
            }
