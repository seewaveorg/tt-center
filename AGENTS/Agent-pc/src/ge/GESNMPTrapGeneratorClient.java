...
public class GESNMPTrapGeneratorClient {

	private static final String community = "public";
	//private static final String trapOid = ".1.3.6.1.2.1.1.6";
        private static final String trapOid = "1.3.6.1.2.1.33.1.6.2.1.2";  // alarm description
        private static final String trapValue = "1.3.6.1.2.1.33.1.6.3.15";  // The UPS system is in the off state
	
        //private static final String ipAddress = "127.0.0.1";
       private static final String ipAddress = "220.247.201.250";
        // private static final String ipAddress = "futurenetwork.dyndns.org";
	...
	private static PDU createPdu(int snmpVersion) {
		...
		pdu.add(new VariableBinding(new OID(trapOid), new OctetString(trapValue)));
		return pdu;
	}
